...
export const ROUTES = {
  ...
  SAMPLE: '/sample',
  PROFILE: '/profile',
  NEW_REGISTER: '/new-register/:registerName',
  REGISTER_TEMPLATE_VIEW: '/register/:templateId/edit-register',
  ...
  VIEW_SET_CHANGE_LOG:'/register/:setId/response-change-log',
  VIEW_TEMPLATE_CHANGE_LOG:'/register/:templateId/register-change-log',
  FILL_SET:'/register/:templateId/fill-set',
  FILL_TABLE:'/register/:templateId/:setId/fill-table',
